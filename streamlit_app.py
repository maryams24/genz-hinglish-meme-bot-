...
# -----------------------------
# Streamlit UI (no theme file; CSS-only)
# -----------------------------
...
st.caption("Commands: /meme … | /caption … | /slang … | /hindi …  • FAAH sound plays when your message includes “faah” (mode = FAAH synth).")
...
user_text = st.chat_input("Type here… (try: /meme faah about skipping gym)")
